...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$title || !$link) {
        ...
        if (isset($_FILES['thumbnail']) && $_FILES['thumbnail']['error'] === UPLOAD_ERR_OK) {
            ...
            $message .= "Error: " . ($uploadErrors[$errCode] ?? "Unknown upload error (Code: $errCode)") . " ";
        }
        ...
        if (empty($message)) {
            ...
            $message .= " (Project data saved, but check upload errors above)";
        }
...
$formHidden = isset($editingProject['hidden']) ? $editingProject['hidden'] : false; // Default to false
...
<head>
    ...
    <style>
        ...
        .project-list a.hidden-project { opacity: 0.5; font-style: italic; }
        .project-list a.hidden-project::after { content: " (Hidden)"; font-size: 0.8em; }
    </style>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="project-list">
            <?php foreach ($projects as $p): ?>
                <li>
                    <a href="?edit=<?= urlencode($p['title']) ?>" class="<?= isset($p['hidden']) && $p['hidden'] ? 'hidden-project' : '' ?>">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div style="margin-top: 5px;">
                    ...
                    <label style="display:inline; font-weight:normal; color: #dc3545;">
                        <input type="checkbox" name="hidden" <?= $formHidden ? 'checked' : '' ?>> Hide Project from Public View
                    </label>
                </div>
            </div>
