...
if (isset($_GET['edit'])) {
    ...
    if (file_exists($filePath)) {
        ...
        // Use string manipulation instead of regex to avoid PCRE limits on large files (e.g. base64 images)
        $startMarker = '<!-- EDITOR_DATA';
        $endMarker = '-->';
